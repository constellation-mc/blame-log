      ...
      if (allowedNames.contains(method.name)) {
        ...
        for (int i = 0; i < types.length; i++) {
          ...
          if ("java.lang.String".equals(type.getClassName())) {
            if ("(Lorg/slf4j/Marker;Ljava/lang/String;ILjava/lang/String;[Ljava/lang/Object;Ljava/lang/Throwable;)V"
                .equals(method.desc)) i += 2;
            sIndex = i;
            break;
          }
        }
      ...
      if (instruction instanceof VarInsnNode varInsnNode) {
        if (varInsnNode.var == objIndex + 1) {
          ...
          newInsn.add(new MethodInsnNode(
              ...
              "me/melontini/blamelog/BlameUtil",
              "getMessage",
              "(Ljava/lang/String;)Ljava/lang/String;"));
        }
      }
      if (instruction instanceof MethodInsnNode methodInsnNode) {
        methodInsnNode.desc = methodInsnNode
            .desc
            .replaceFirst("Ljava/lang/Object;", "Ljava/lang/String;Ljava/lang/Object;")
            .replace("Ljava/lang/Throwable;", "Ljava/lang/Object;");
      }
